...
public final class DatabaseShardingStrategyTest {
    ...
    public void assertDatabaseShardingStrategyWithSingleShardingColumn() {
        assertThat(new StandardShardingStrategy(new StandardShardingStrategyConfiguration("shardingColumn", new PreciseOrderShardingAlgorithm(), null)).getShardingColumns(), is((Collection<String>) Sets.newTreeSet(Collections.singleton("shardingColumn"))));
    }
}
