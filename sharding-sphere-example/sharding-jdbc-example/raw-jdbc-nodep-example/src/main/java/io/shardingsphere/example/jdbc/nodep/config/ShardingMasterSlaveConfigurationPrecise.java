...
public final class ShardingMasterSlaveConfigurationPrecise implements ExampleConfiguration {
    ...
    private static Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("demo_ds_master_0", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_MASTER, "demo_sharding_master_0", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        result.put("demo_ds_master_0_slave_0", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_SLAVE_0, "demo_sharding_master_0_slave_0", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        result.put("demo_ds_master_0_slave_1", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_SLAVE_1, "demo_sharding_master_0_slave_1", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        result.put("demo_ds_master_1", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_MASTER, "demo_sharding_master_1", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        result.put("demo_ds_master_1_slave_0", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_SLAVE_0, "demo_sharding_master_1_slave_0", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        result.put("demo_ds_master_1_slave_1", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_SLAVE_1, "demo_sharding_master_1_slave_1", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        return result;
    }
}
