...
public final class ShardingTablesConfigurationPrecise implements ExampleConfiguration {
    ...
    private static Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("demo_ds", DataSourceUtil.createDataSource(DataSourceUtil.HOST_CUSTOM, DataSourceUtil.PORT_MASTER, "demo_sharding_tables", DataSourceUtil.USERNAME, DataSourceUtil.PASSWORD));
        return result;
    }
}
